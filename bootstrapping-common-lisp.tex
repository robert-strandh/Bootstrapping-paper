...
\clanguage{} \cite{iso:c}.  The only widespread \commonlisp{}
implementation written mainly in \commonlisp{}, and that is built with
bootstrapping, is \sbcl{}
